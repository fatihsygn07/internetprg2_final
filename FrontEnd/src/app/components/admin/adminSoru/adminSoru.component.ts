...
@Component({
  selector: 'app-adminSoru',
  templateUrl: './adminSoru.component.html',
  styleUrls: ['./adminSoru.component.css']
})
export class adminSoruComponent implements OnInit {

  Sorular:Makale[];
  dataSource:any;
  displayedColumns:['Baslik','Icerik','detay',];
  ...
  SoruListe(){
    this.apiServis.MakaleListe().subscribe((d:any)=>{
      this.Sorular = d;
