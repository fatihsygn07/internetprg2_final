...
namespace myoBlog32API.Controllers
{
    ...
    public class ServisController : ApiController
    {
        ...
        {
            List<SoruModel> liste = db.Soru.OrderByDescending(o => o.SoruId).Take(
           s).Select(x => new SoruModel()
           {
               SoruId = x.SoruId,
               Baslik = x.Baslik,
               Icerik = x.Icerik,
        ...
        {
            List<SoruModel> liste = db.Soru.Where(s => s.KategoriId == katId).Select
           (x => new SoruModel()
           {
               SoruId = x.SoruId,
               Baslik = x.Baslik,
        ...
        {
            List<SoruModel> liste = db.Soru.Where(s => s.UyeId == uyeId).Select(x =>
           new SoruModel()
           {
               SoruId = x.SoruId,
               Baslik = x.Baslik,
        ...
        [HttpPost]
        [Route("api/Soruekle")]
        public SonucModel SorueEkle(SoruModel model)
        {
        ...
        public SonucModel MakaleSil(int SoruId)
        {
        ...
        {
            List<YorumModel> liste = db.Yorum.Where(s => s.YorumUyeId == uyeId).Select(x => new YorumModel()
            {
                YorumId = x.YorumId,
                YorumIcerik = x.YorumIcerik,
                SoruId = x.SoruId,
        ...
        {
            List<YorumModel> liste = db.Yorum.Where(s => s.SoruId == makaleId).Select(
           x => new YorumModel()
           {
               YorumId = x.YorumId,
               YorumIcerik = x.YorumIcerik,
        ...
        {
            List<YorumModel> liste = db.Yorum.OrderByDescending(o => o.SoruId).Take(s)
        ...
        {
            if (db.Yorum.Count(s => s.YorumUyeId == model.UyeId && s.SoruId == model.SoruId && s.YorumIcerik == model.YorumIcerik) > 0)
            {
                sonuc.islem = false;
